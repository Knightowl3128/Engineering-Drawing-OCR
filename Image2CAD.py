...
def main(argv1, scale, show=False):
    ...
    for j in segments:
        for i in j._Leaders:
            ...
            start, end = (P1.x/scale,P1.y/scale),(P2.x/scale,P2.y/scale)
            line_alignment = None
            if start[1] == end[1]:
                line_alignment = 'Horizontal'
            elif start[0] == end[0]:
                line_alignment = 'Vertical'

            segment_lines.append([start, end, line_alignment])
    ...
    return arrow_dict, segment_lines, Erased_Img
